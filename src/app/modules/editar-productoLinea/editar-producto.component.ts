...
export class EditarProductoLineaComponent {
  ...
  constructor(
    public dialogo: MatDialogRef<EditarProductoLineaComponent>,
    ...
    this.productoService.consultarProductos(this.idProducto).subscribe(
