...
export class UploadService {
  ...
  API: string =
    'https://olympus.arvispace.com/gimnasioRoles/configuracion/superAdministrador/creaProductoV3.php';
  ...
  subirImagenes(idPrducto:number, imagenes: File[]): Observable<any> {
    ...
    return this.clienteHttp.post(this.API + '?subirImagenes'+idPrducto, formData);
  }
}
